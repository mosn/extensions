...
func TestBmr2BirDetailTrue(t *testing.T) {
	...
	header := map[string]string{"TraceId": "CBT02100000000000011", "SpanId": "CBT01100000000000011"}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			br2br, _ := NewBumsReq2BeisReq(header, tt.fields, tt.cfg)
			got, _ := br2br.Transcoder()
