...
目前开源项目[sofastack-mesh-demo](https://github.com/sofastack-guides/sofastack-mesh-demo.git ) 集成了bolt、dubbo和springcloud技术栈客户端和服务端示例，可以配合mosn进行服务调用。

[sofastack-mesh-demo](https://github.com/sofastack-guides/sofastack-mesh-demo.git ) 演示程序jvm参数(需要具备内网访问权限):
